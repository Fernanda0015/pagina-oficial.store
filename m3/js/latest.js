...
function getCompleteParams() {
  ...
  const MEDIUM_SEPARATOR = 'rKm-km-rKm';
  ...
  completeParams.set('utm_campaign', utmCampaign.includes(MEDIUM_SEPARATOR) ? utmCampaign : `${utmCampaign}${MEDIUM_SEPARATOR}${utmMedium}`);
